 ...
 * @author Ampelio
 */
@WebFilter(urlPatterns ={"/vistas_administrador/administradorModuloPrincipal.jsp", "/vistas_administrador/administradorClientes.jsp", "/vistas_administrador/administradorProductos.jsp", "/vistas_administrador/administradorPedidos.jsp"})
public class FiltroSeguridadAdministrador implements Filter {
    ...
    public FiltroSeguridadAdministrador() {
    }    
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session == null || session.getAttribute("usuario") == null) {
            ...
            httpResponse.sendRedirect(httpRequest.getContextPath() + "/vistas_administrador/administradorLogin.jsp");
        } else {
