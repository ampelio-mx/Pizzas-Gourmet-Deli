 ...
 * @author Ampelio
 */
@WebFilter(urlPatterns ={"/vistas/formularioRegistroClienteListar.jsp", "/vistas/ordenpedido.jsp"})
public class FiltroSeguridadClientes implements Filter {
    ...
    public FiltroSeguridadClientes() {
    }    
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (session == null || session.getAttribute("idUser") == null) {
            ...
            httpResponse.sendRedirect(httpRequest.getContextPath() + "/vistas/userLogin.jsp");
        } else {
