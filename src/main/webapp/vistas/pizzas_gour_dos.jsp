                ...
                <div class="columna-contenedor-cards col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <script>
                                ...
                                body: JSON.stringify(datos)
                                    ...
                                    .then(data => {
                                        ...
                                        switch (formulario) {
                                            ...
                                            case "2005":
                                                resultadoDiv = document.getElementById('labelParametros_2005');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "2006":
                                                resultadoDiv = document.getElementById('labelParametros_2006');
                                                resultadoDiv.innerHTML = "$" + precioPizza;

                                                break;

                                            case "2007":
                                                resultadoDiv = document.getElementById('labelParametros_2007');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "2008":
                                                resultadoDiv = document.getElementById('labelParametros_2008');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;
                        ...
                        function restarCantidadSelect(disminuir) {
                            ...
                            if (btnDismunuir === "boton-disminuir_2005") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2005");
                                ...
                                var precioactual = document.getElementById('labelParametros_2005');
                            ...
                            } else if (btnDismunuir === "boton-disminuir_2006") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2006");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2006');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_2007") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2007");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2003');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_2008") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2008");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2008');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            }
                        ...
                        function sumarCantidadSelect(aumentar) {
                            ...
                            if (btnAumentar === "boton-aumentar_2005") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2005");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_2006") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2006");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_2007") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2007");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                console.log("El número es: " + contador);
                                var precioactual = document.getElementById('labelParametros_2007');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_2008") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2008");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                        ...
                        function enviarPedido(agregarproducto) {
                            ...
                            if (productoAgregado === "boton-agregar-pizza_2005") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2005").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2006") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2006").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2007") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2007").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2008") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2008").innerText;
                                console.log(cantidadselected);
                            }
