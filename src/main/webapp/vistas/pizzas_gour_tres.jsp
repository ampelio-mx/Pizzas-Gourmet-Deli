                ...
                <div class="columna-contenedor-cards">
                    ...
                    <script>
                                ...
                                body: JSON.stringify(datos)
                                    ...
                                    .then(data => {
                                        ...
                                        switch (formulario) {
                                            ...
                                            case "2009":
                                                resultadoDiv = document.getElementById('labelParametros_2009');
                                                resultadoDiv.innerHTML = precioPizza;
                                                break;

                                            case "2010":
                                                resultadoDiv = document.getElementById('labelParametros_2010');
                                                resultadoDiv.innerHTML = precioPizza;

                                                break;

                                            case "2011":
                                                resultadoDiv = document.getElementById('labelParametros_2011');
                                                resultadoDiv.innerHTML = precioPizza;
                                                break;

                                            case "2012":
                                                resultadoDiv = document.getElementById('labelParametros_2012');
                                                resultadoDiv.innerHTML = precioPizza;
                                                break;
                        ...
                        function restarCantidadSelect(disminuir) {
                            ...
                            if (btnDismunuir === "boton-disminuir_2009") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2009");
                                ...
                                var precioactual = document.getElementById('labelParametros_2009');
                                precioactual.innerHTML = precioProducto * contador;
                            } else if (btnDismunuir === "boton-disminuir_2010") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2010");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2010');
                                precioactual.innerHTML = precioProducto * contador;
                            } else if (btnDismunuir === "boton-disminuir_2011") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2011");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2011');
                                precioactual.innerHTML = precioProducto * contador;
                            } else if (btnDismunuir === "boton-disminuir_2012") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2012");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2012');
                                precioactual.innerHTML = precioProducto * contador;
                            }
                        ...
                        function sumarCantidadSelect(aumentar) {
                            ...
                            if (btnAumentar === "boton-aumentar_2009") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2009");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2009');
                                precioactual.innerHTML = precioProducto * contador;
                            } else if (btnAumentar === "boton-aumentar_2010") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2010");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2010');
                                precioactual.innerHTML = precioProducto * contador;
                            } else if (btnAumentar === "boton-aumentar_2011") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2011");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2011');
                                precioactual.innerHTML = precioProducto * contador;
                            } else if (btnAumentar === "boton-aumentar_2012") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2012");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                        ...
                        function enviarPedido(agregarproducto) {
                            ...
                            if (productoAgregado === "boton-agregar-pizza_2009") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2009").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2010") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2010").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2011") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2011").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2012") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2012").innerText;
                                console.log(cantidadselected);
                            }
