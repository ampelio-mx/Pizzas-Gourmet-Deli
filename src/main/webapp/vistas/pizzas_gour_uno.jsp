                ...
                <div class="columna-contenedor-cards col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <script>
                                ...
                                body: JSON.stringify(datos)
                                    ...
                                    .then(data => {
                                        ...
                                        switch (formulario) {
                                            ...
                                            case "2001":
                                                resultadoDiv = document.getElementById('labelParametros_2001');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "2002":
                                                resultadoDiv = document.getElementById('labelParametros_2002');
                                                resultadoDiv.innerHTML = "$" + precioPizza;

                                                break;

                                            case "2003":
                                                resultadoDiv = document.getElementById('labelParametros_2003');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "2004":
                                                resultadoDiv = document.getElementById('labelParametros_2004');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;
                        ...
                        function restarCantidadSelect(disminuir) {
                            ...
                            if (btnDismunuir === "boton-disminuir_2001") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2001");
                                ...
                                var precioactual = document.getElementById('labelParametros_2001');
                            ...
                            } else if (btnDismunuir === "boton-disminuir_2002") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2002");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2002');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_2003") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2003");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            }else if (btnDismunuir === "boton-disminuir_2004") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2004");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_2004');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            }
                        ...
                        function sumarCantidadSelect(aumentar) {
                            ...
                            if (btnAumentar === "boton-aumentar_2001") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2001");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_2002") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2002");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if  (btnAumentar === "boton-aumentar_2003") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2003");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_2004") {
                                var contadorLabel = document.getElementById("cant-Pizzas_2004");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                        ...
                        function enviarPedido(agregarproducto) {
                            ...
                            if (productoAgregado === "boton-agregar-pizza_2001") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2001").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2002") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2002").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2003") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2003").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_2004") {
                                var cantidadselected = document.getElementById("cant-Pizzas_2004").innerText;
                                console.log(cantidadselected);
                            }
