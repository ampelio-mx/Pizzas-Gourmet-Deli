                ...
                <div class="columna-contenedor-cards col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <script>
                                ...
                                body: JSON.stringify(datos)
                                    ...
                                    .then(data => {
                                        ...
                                        switch (formulario) {
                                            ...
                                            case "1013":
                                                resultadoDiv = document.getElementById('labelParametros_1013');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "1014":
                                                resultadoDiv = document.getElementById('labelParametros_1014');
                                                resultadoDiv.innerHTML = "$" + precioPizza;

                                                break;

                                            case "1015":
                                                resultadoDiv = document.getElementById('labelParametros_1015');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;
                        ...
                        function restarCantidadSelect(disminuir) {
                            ...
                            if (btnDismunuir === "boton-disminuir_1013") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1013");
                                ...
                                var precioactual = document.getElementById('labelParametros_1013');
                            ...
                            } else if (btnDismunuir === "boton-disminuir_1014") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1014");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1014');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_1015") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1015");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1015');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            }
                        ...
                        function sumarCantidadSelect(aumentar) {
                            ...
                            if (btnAumentar === "boton-aumentar_1013") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1013");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1014") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1014");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if  (btnAumentar === "boton-aumentar_1015") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1015");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                        ...
                        function enviarPedido(agregarproducto) {
                            ...
                            if (productoAgregado === "boton-agregar-pizza_1013") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1013").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1014") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1014").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1015") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1015").innerText;
                                console.log(cantidadselected);
                            }                             
