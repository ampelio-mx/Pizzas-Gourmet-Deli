                ...
                <div class="columna-contenedor-cards col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <script>
                                ...
                                body: JSON.stringify(datos)
                                    ...
                                    .then(data => {
                                        ...
                                        switch (formulario) {
                                            ...
                                            case "1009":
                                                resultadoDiv = document.getElementById('labelParametros_1009');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "1010":
                                                resultadoDiv = document.getElementById('labelParametros_1010');
                                                resultadoDiv.innerHTML = "$" + precioPizza;

                                                break;

                                            case "1011":
                                                resultadoDiv = document.getElementById('labelParametros_1011');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "1012":
                                                resultadoDiv = document.getElementById('labelParametros_1012');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;
                        ...
                        function restarCantidadSelect(disminuir) {
                            ...
                            if (btnDismunuir === "boton-disminuir_1009") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1009");
                                ...
                                var precioactual = document.getElementById('labelParametros_1009');
                            ...
                            } else if (btnDismunuir === "boton-disminuir_1010") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1010");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1010');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_1011") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1011");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1011');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_1012") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1012");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1012');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            }
                        ...
                        function sumarCantidadSelect(aumentar) {
                            ...
                            if (btnAumentar === "boton-aumentar_1009") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1009");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1010") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1010");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1011") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1011");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1012") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1012");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                        ...
                        function enviarPedido(agregarproducto) {
                            ...
                            if (productoAgregado === "boton-agregar-pizza_1009") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1009").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1010") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1010").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1011") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1011").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1012") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1012").innerText;
                                console.log(cantidadselected);
                            }
