                ...
                <div class="columna-contenedor-cards col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    ...
                    <script>
                                ...
                                body: JSON.stringify(datos)
                                    ...
                                    .then(data => {
                                        ...
                                        switch (formulario) {
                                            ...
                                            case "1001":
                                                resultadoDiv = document.getElementById('labelParametros_1001');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "1002":
                                                resultadoDiv = document.getElementById('labelParametros_1002');
                                                resultadoDiv.innerHTML = "$" + precioPizza;

                                                break;

                                            case "1003":
                                                resultadoDiv = document.getElementById('labelParametros_1003');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;

                                            case "1004":
                                                resultadoDiv = document.getElementById('labelParametros_1004');
                                                resultadoDiv.innerHTML = "$" + precioPizza;
                                                break;
                        ...
                        function restarCantidadSelect(disminuir) {
                            ...
                            if (btnDismunuir === "boton-disminuir_1001") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1001");
                                ...
                                var precioactual = document.getElementById('labelParametros_1001');
                            ...
                            } else if (btnDismunuir === "boton-disminuir_1002") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1002");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1002');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_1003") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1003");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1003');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnDismunuir === "boton-disminuir_1004") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1004");
                                var contador = parseInt(contadorLabel.innerText);
                                if (contador > 1) {
                                    contador = contador - 1;
                                    contadorLabel.innerText = contador;
                                ...
                                var precioactual = document.getElementById('labelParametros_1004');
                                var concatenaprecioactual = precioProducto * contador;
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            }
                        ...
                        function sumarCantidadSelect(aumentar) {
                            ...
                            if (btnAumentar === "boton-aumentar_1001") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1001");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1002") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1002");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1003") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1003");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                                ...
                                var concatenaprecioactualredondeado = concatenaprecioactual.toFixed(2);
                                precioactual.innerHTML = "$" + concatenaprecioactualredondeado;
                            } else if (btnAumentar === "boton-aumentar_1004") {
                                var contadorLabel = document.getElementById("cant-Pizzas_1004");
                                var contador = parseInt(contadorLabel.innerText);
                                contador = contador + 1;
                                contadorLabel.innerText = contador;
                        ...
                        function enviarPedido(agregarproducto) {
                            ...
                            if (productoAgregado === "boton-agregar-pizza_1001") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1001").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1002") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1002").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1003") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1003").innerText;
                                console.log(cantidadselected);
                            } else if (productoAgregado === "boton-agregar-pizza_1004") {
                                var cantidadselected = document.getElementById("cant-Pizzas_1004").innerText;
                                console.log(cantidadselected);
                            }
